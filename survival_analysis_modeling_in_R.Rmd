...
We're probably more interested in time-until-failure by treatment group (rx). For this we specify formula `Surv(survt, status) ~ rx`. Now we see different estimated median survival times by rx group.
